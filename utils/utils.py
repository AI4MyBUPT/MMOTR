...
def collate_MIL_survival_sig(batch):
    ...
    slide_id = [item[10] for item in batch][0]
    return [img, omic1, omic2, omic3, omic4, omic5, omic6, label, event_time, c, slide_id]
...
def get_custom_exp_code(args):
    ...
    ### Model Type
    if args.model_type in ['mcsp_otmr', 'mcat'] and args.generator:
      param_code += 'MCSPOTMR'
    elif args.model_type in ['mcsp_otmr', 'mcat'] and not args.generator:
      param_code += 'MCSP'
